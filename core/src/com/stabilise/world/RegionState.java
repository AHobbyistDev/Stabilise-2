...
public class RegionState {
    ...
    private enum State {
         ...
         * Transitions to {@link #LOADING} via {@link #getLoadPermit()}. */
        NEW,
         ...
         * Transitions to {@link #PREPARED} via {@link #setGenerated()}. */
        GENERATING,
     ...
     *
     * <p>All save state control is localised to {@link #getSavePermit()}
     * and {@link #finishSaving()}.
     */
     ...
     * documentation for {@link State#NEW} and all other states. Default value
     * is {@link State#NEW}. */
    private final AtomicReference<State> state = new AtomicReference<>(State.NEW);
    /** Keeps track of whether the region is being saved. */
    @GuardedBy("this")
    private SaveState saveState = SaveState.NOT_SAVING;
    /** Whether the region has been generated. Note that this is distinct from
     * {@link State#PREPARED}, since a region can be generated at time of
     * loading, but still in need of preparation to implant structures. */
     ...
     * prepared. */
    private final AtomicInteger preparedNeighbours = new AtomicInteger();
     ...
     * @param queuedStructures Whether the region {@link
