...
/**
 * This packet indicates a packet send request.
 * e.g. This can be sent by the client to request the server to resent the
 * ServerInfo packet when the user refreshes the server list.
 */
