...
//
//import com.stabilise.entity.component.controller.MobController;
...
// */
//public abstract class EntityMob extends EntityOld {
//    
//    //--------------------==========--------------------
...
//     */
//    protected void dropItem(World world, Item item, int count, float chance) {
//        if(world.getRnd().nextFloat() > chance)
//            return;
//        EntityItem e = new EntityItem(item.stackOf(count));
//        e.pop(world.getRnd());
