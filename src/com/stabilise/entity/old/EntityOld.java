...
// * physical laws.
// */
//public abstract class EntityOld extends FreeGameObject {
//    
//    //--------------------==========--------------------
...
//    
//    private static final TypeFactory<EntityOld> ENTITIES =
...
//        
//        float leadingEdge = dxp ? boundingBox.maxX() : boundingBox.minX();
//        
//        xp += leadingEdge;
//        
...
//        double max = Math.ceil(yp + boundingBox.maxY());
//        
//        // TODO: < vs <= - watch out for this, it may cause problems in the future
//        for(double v = yp + boundingBox.minY(); v < max; v++) {
...
//        
//        float leadingEdge = dyp ? boundingBox.maxY() : boundingBox.minY();
//        
//        yp += leadingEdge;
//        
...
//        double max = Math.ceil(xp + boundingBox.maxX());
//        
//        // TODO: < vs <= - watch out for this, it may cause problems in the future
//        for(double h = xp + boundingBox.minX(); h < max; h++) {
...
//            x = Math.floor(xp) - boundingBox.maxX();
//        } else {
//            x = Math.ceil(xp) - boundingBox.minX();
//        }
//    }
//    
//    /**
...
//            y = Math.floor(yp) - boundingBox.maxY();
//        } else {
//            y = Math.ceil(yp) - boundingBox.minY();
//            
...
//     */
//    public static EntityOld createEntity(int id) {
