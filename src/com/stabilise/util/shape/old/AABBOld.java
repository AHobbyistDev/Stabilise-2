 ...
 */
@Deprecated
public class AABBOld extends AbstractPolygon {
     ...
     */
    public AABBOld(Vec2 v00, Vec2 v11) {
        this.v00 = v00;
        this.v11 = v11;
    }
    
    @Override
    public AABBOld transform(UnaryOperator<Vec2> f) {
        return new AABBOld(f.apply(v00), f.apply(v11));
    }
     ...
     */
    @Override
    public AABBOld rotate(float rotation) {
    ...
    */
    ...
    public boolean intersectsPolygon(AbstractPolygon p) {
        if(p instanceof AABBOld)
            return intersectsAABB((AABBOld)p);
    ...
    public boolean contains(Shape s) {
        if(s instanceof AABBOld)
            return containsAABB((AABBOld)s);
