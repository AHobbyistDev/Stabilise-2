 ...
 * framework. You can think of a {@code TaskRunnable} as  equivalent to a
 * {@code Runnable} which accepts a {@code TaskHandle} through which to
 * communicate to the Task API.
 */
