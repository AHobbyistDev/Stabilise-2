...
///**
// */
//public class IntHashMap2<V> extends AbstractMap<Integer,V> {
//    
//    
//    /*
...
//     */
//    static class Node<V> implements Map.Entry<Integer,V> {
//        final int key;
//        V value;
//        Node<V> next;
//
...
//     */
//    public IntHashMap2(Map<Integer, ? extends V> m) {
...
//     */
//    final void putMapEntries(Map<Integer, ? extends V> m, boolean evict) {
//        int s = m.size();
//        if (s > 0) {
...
//                e = ((TreeNode<V>)p).putTreeVal(this, tab, key, value);
//            else {
...
//        public final void clear()               { IntHashMap2.this.clear(); }
//        public final Iterator<Integer> iterator(){ return new KeyIterator(); }
//        public final boolean contains(Object o) { return containsKey((Integer)o); }
//        public final boolean remove(Object key) {
//            return removeNode((Integer)key, null, false, true) != null;
//        }
//        public final Spliterator<Integer> spliterator() {
//            return new KeySpliterator<>(IntHashMap2.this, 0, -1, 0, 0);
//        }
...
//            return new ValueSpliterator<>(IntHashMap2.this, 0, -1, 0, 0);
//        }
...
//            return new EntrySpliterator<>(IntHashMap2.this, 0, -1, 0, 0);
//        }
...
//        return removeNode((Integer)key, value, true, true) != null;
//    }
//
//    @Override
...
//    TreeNode<V> newTreeNode(int key, V value, Node<V> next) {
...
//     * linked node.
//     */
//    static final class TreeNode<V> extends LinkedHashMap.Entry<Integer,V> {
//        TreeNode<V> parent;  // red-black tree links
//        TreeNode<V> left;
//        TreeNode<V> right;
//        TreeNode<V> prev;    // needed to unlink next upon deletion
//        boolean red;
//        TreeNode(int key, V val, Node<V> next) {
//            super(key, val, next);
//        }
//
//        /**
...
//         * comparing keys.
//         */
//        final TreeNode<V> find(int h, Object k, Class<?> kc) {
//            TreeNode<V> p = this;
//            do {
//                int ph, dir; K pk;
...
//         * this node.
//         */
//        final Node<V> untreeify(HashMap<K,V> map) {
...
//         */
//        final TreeNode<V> putTreeVal(HashMap<K,V> map, Node<V>[] tab,
//                                       int h, K k, V v) {
//            Class<?> kc = null;
...
//         */
//        final void removeTreeNode(HashMap<K,V> map, Node<V>[] tab,
//                                  boolean movable) {
//            int n;
...
//         */
//        final void split(HashMap<K,V> map, Node<V>[] tab, int index, int bit) {
//            TreeNode<V> b = this;
...
//
//        static <K,V> TreeNode<V> rotateLeft(TreeNode<V> root,
//                                              TreeNode<V> p) {
//            TreeNode<V> r, pp, rl;
...
//        }
//
//        static <K,V> TreeNode<V> rotateRight(TreeNode<V> root,
//                                               TreeNode<V> p) {
//            TreeNode<V> l, pp, lr;
...
//        }
//
//        static <K,V> TreeNode<V> balanceInsertion(TreeNode<V> root,
//                                                    TreeNode<V> x) {
//            x.red = true;
...
//        }
//
//        static <K,V> TreeNode<V> balanceDeletion(TreeNode<V> root,
//                                                   TreeNode<V> x) {
